...
class ServiceOnBoarding {
  search(head, param) {
    return new Promise((resolve, reject) => {
      console.log(" - - ServiceOnBoarding : search : [START] *** ");
      console.log(" - - ServiceOnBoarding : search : [HEAD] => ", head);
      console.log(" - - ServiceOnBoarding : search : [PARAM] => ", param);
      ...
      new ServiceHelperHttp()
        ...
        .then(resultObj => {
          console.log(
            " - - ServiceOnBoarding : search : [resultObj] , ",
            resultObj
          );
          ...
          try {
            ...
            console.log(
              " - - ServiceOnBoarding : search : [EXCEPTION - INNER], ",
              e
            );
        ...
        .catch(e => {
          console.log(" - - ServiceOnBoarding : search : [EXCEPTION] , ", e);
          reject(e);
        });

      console.log(" - - ServiceOnBoarding : search : [END] *** ");
    });
  }

  submit(head, param) {
    return new Promise((resolve, reject) => {
      console.log(" - - ServiceOnBoarding : submit : [START] *** ");
      console.log(" - - ServiceOnBoarding : submit : [HEAD] => ", head);
      console.log(" - - ServiceOnBoarding : submit : [PARAM] => ", param);
      ...
      new ServiceHelperHttp()
        ...
        .then(resultObj => {
          console.log(
            " - - ServiceOnBoarding : submit : [resultObj] , ",
            resultObj
          );
          ...
          try {
            ...
            console.log(
              " - - ServiceOnBoarding : submit : [EXCEPTION - INNER], ",
              e
            );
            throw new ExceptionGeneral("Mapping Exception");
          }
        ...
        .catch(e => {
          console.log(" - - ServiceOnBoarding : submit : [EXCEPTION] , ", e);
          reject(e);
        });

      console.log(" - - ServiceOnBoarding : submit : [END] *** ");
    });
  }
}

export default new ServiceOnBoarding();
