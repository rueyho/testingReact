...
import ComponentOnBoardingDetaisStep1 from "../../onBoarding/details/c.onBoarding.detail.step1";
import ComponentOnBoardingDetaisStep2 from "../../bank/details/c.bank.detail.step2";
import ComponentOnBoardingDetaisStep3 from "../../bank/details/c.bank.detail.step3";
...
class ComponentOnBoardingDetais extends ComponentAbstract {
  constructor(props) {
    super(props);

    console.log(
      "ComponentOnBoardingDetais : constructor : *** : [" + this.uuid() + "] ",
      props
    );
  ...
  requestPreview() {
    console.log("ComponentOnBoardingDetais requestPreview");
  ...
  requestSubmit() {
    console.log("ComponentOnBoardingDetais requestSubmit");
  ...
  requestSubmitDone(result) {
    console.log("ComponentOnBoardingDetais requestSubmit", result);
        ...
        <Grid container className={classes.wrapper}>
          ...
          <Paper className={classes.paper}>
            <ComponentCustomStepper
              title={"ONBOARD - Detail"}
              step={step}
            ></ComponentCustomStepper>

            {step === 0 && (
              <div style={{ padding: 15 }}>
                <ComponentOnBoardingDetaisStep1
            ...
            {/* {step === 1 && (
              <div style={{ padding: 15 }}>
                <ComponentOnBoardingDetaisStep2
                  result={result}
                  onNext={() => {
                    this.requestPreview();
                  }}
            ...
            {step === 2 && (
              <div style={{ padding: 15 }}>
                <ComponentOnBoardingDetaisStep3
                  result={result}
                  onNext={() => {
...
export default reduxConnect(useStyles(ComponentOnBoardingDetais));
