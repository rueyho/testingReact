...
class ComponentHome extends ComponentAbstract {
  constructor(props) {
    super(props);

    console.log(
      "ComponentHome : constructor : *** : [" + this.uuid() + "] ",
      props
    );
  ...
  onClickReset() {
    console.log("ComponentHome onClickReset");
  ...
  onClickSearch() {
    console.log("ComponentHome onClickSearch");
  }
  onClickAddNew() {
    console.log("ComponentHome onClickAddNew");
  ...
  requestSearch() {
    console.log("ComponentHome requestSearch");
  ...
  requestSearchDone(result) {
    console.log(
      "ComponentHome : requestSearchDone : ***  : result => ",
      result
    );
  ...
  requestLogin() {
    HelperNavigate.route(HelperNavigate.mapPath(HelperNavigateENUM.HOME));
  }
...
export default reduxConnect(useStyles(ComponentHome));
